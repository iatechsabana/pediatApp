      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
            prefixIcon: Icon(Icons.badge_outlined, color: Colors.white.withOpacity(0.9)),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
          ),
          validator: (v) {
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
            prefixIcon: Icon(Icons.medical_services_outlined, color: Colors.white.withOpacity(0.9)),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
          ),
          validator: (v) {
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
            prefixIcon: Icon(Icons.map_outlined, color: Colors.white.withOpacity(0.9)),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
          ),
        ),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
            prefixIcon: Icon(Icons.schedule, color: Colors.white.withOpacity(0.9)),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
          ),
        ),
      ],
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Crear cuenta', style: TextStyle(color: Colors.white.withOpacity(0.98), fontSize: 24, fontWeight: FontWeight.w800)),
                      const SizedBox(height: 6),
                      Text('Elige tipo de cuenta y completa los datos', style: TextStyle(color: Colors.white.withOpacity(0.9))),
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _accountType == AccountType.user ? Colors.white.withOpacity(0.18) : Colors.transparent,
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                padding: const EdgeInsets.symmetric(vertical: 12),
                                decoration: BoxDecoration(
                                  color: _accountType == AccountType.pediatrician ? Colors.white.withOpacity(0.18) : Colors.transparent,
                                  borderRadius: BorderRadius.circular(10),
                                  border: Border.all(color: Colors.white.withOpacity(0.12)),
                                ),
                                child: Center(child: Text('Pediatra', style: TextStyle(color: Colors.white))),
                              ),
                            ),
                          ),
                        ],
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
                          prefixIcon: Icon(Icons.person_outline, color: Colors.white.withOpacity(0.9)),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                        ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.white.withOpacity(0.85)),
                          prefixIcon: Icon(Icons.phone_outlined, color: Colors.white.withOpacity(0.9)),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                        ),
                      ),
                      ...
                      const SizedBox(height: 12),
                      Center(child: Text('Al registrarte aceptas los términos', style: TextStyle(color: Colors.white.withOpacity(0.85)))),
                    ],
                  ),
                ),
              ),
